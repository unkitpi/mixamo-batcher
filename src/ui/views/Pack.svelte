...
<Main>
  <Sticky>
    ...
    {#if showSettings}
      ...
      <Section>
        <Heading>Animation Placement</Heading>
        <label class="pack-option">
          <input type="checkbox" bind:checked={project.inplace} />
          In Place for Entire Pack
        </label>
        <div class="help-text">
          Applies to every animation unless that animation has its own download override.
        </div>
      </Section>
      <Section>
